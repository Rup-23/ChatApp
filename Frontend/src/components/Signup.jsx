        ...
        <>
            <div className='flex h-screen items-center justify-center'>
                <form onSubmit={handleSubmit(onSubmit)}
                    className='border border-slate-400 px-6 py-2 rounded-md space-y-5 w-96'>
                    <h1 className='text-2xl text-center font-semibold'>Chat <span className='text-violet-500 font-semibold'>App</span></h1>
                    ...
                    {errors.confirmPassword && <span className='text-red-600 text-sm font-semibold'>
